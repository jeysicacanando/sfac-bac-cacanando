...
?>
<title>
    View Executive List | SFAC - Bacoor
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Executives List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Executives List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic"
                                ...
                                <tbody>
                                    <?php
                                    $listExecutive = mysqli_query($db, "SELECT *, CONCAT(facul.faculty_lastname, ', ', facul.faculty_firstname, ' ', facul.faculty_middlename) AS fullname 
                                            FROM tbl_faculties_staff AS facul");
                                    while ($row = mysqli_fetch_array($listExecutive)) {
                                        $id = $row['faculty_id'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.executive.php?facultyStaff_id=<?php echo $id; ?>"><i
                                                ...
                                                <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="userData/ctrl.del.executive.php?facultyStaff_id=<?php echo $id; ?>"
