...
?>
<title>
    View Guidance List | SFAC - Bacoor
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Guidances List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Guidances List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic"
                                ...
                                <tbody>
                                    <?php
                                    $listGuidance = mysqli_query($db, "SELECT *, CONCAT(facul.guidance_lastname, ', ', facul.guidance_firstname, ' ', facul.guidance_middlename) AS fullname 
                                            FROM tbl_guidances AS facul");
