                    ...
                    <div class="card shadow shadow-xl">
                       ...
                       <div class="row d-flex justify-content-center mx-4">
                            <div class="col-md-6 m-1 ">
                                <form method="GET" action="pendingStud.php">
                                ...
                                <tbody>
                                    ...
                                    $studentList = mysqli_query(
                                        ...
                                        "SELECT *,CONCAT(tbl_students.lastname, ', ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname
                                            ...
                                            WHERE remark IN ('Pending') AND ay_id IN ('$_SESSION[AC]') AND sem_id IN ('$_SESSION[S]') AND
                                            ...
                                            stud_no LIKE '%$_GET[search_text]%' OR
                                            year_level LIKE '%$_GET[search_text]%' OR
                                            status LIKE'%$_GET[search_text]%' OR
                                            date_enrolled LIKE'%$_GET[search_text]%')
