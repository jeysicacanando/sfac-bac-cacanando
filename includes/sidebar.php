<aside
    ...
    <div class="sidenav-header">
        ...
        <div class="d-flex align-items-start flex-column justify-content-center">
            ...
            } elseif ("Executive" == $_SESSION['role']) {
                $getUserName = mysqli_query($db, "SELECT *, CONCAT(tbl_faculties_staff.faculty_lastname, ', ', tbl_faculties_staff.faculty_firstname) AS fullname FROM tbl_faculties_staff WHERE faculty_id = '$faculty_id'");
                while ($row = mysqli_fetch_array($getUserName)) {
                    echo '<img src="data:image/jpeg;base64,' . base64_encode($row['img']) . '" class="border-radius-lg mx-3 shadow zoom" alt="main_logo" style="height: 40px; width: 40px;">
                           <div class="d-flex align-items-start flex-column justify-content-center">
    ...
    <div class="collapse navbar-collapse  w-auto max-height-vh-90" id="sidenav-collapse-main">
        ...
        <a class="nav-link  " href="../accounting/list.accounting.php">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../guidance/list.guidance.php">
                    ...
                    <span class="nav-link-text ms-1">Guidances List</span>
                </a>
            </li>

            <li class="nav-item">
            <a class="nav-link  " href="../executive/list.executive.php">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="far fa-list-alt text-dark" style="height: 12px; width: 12px;"></i>
                </div>
                <span class="nav-link-text ms-1">Executives List</span>
            </a>
        </li>
        ...
        <a class="nav-link  " href="../accounting/add.accounting.php">
            ...
            <li class="nav-item">
            <a class="nav-link  " href="../executive/add.executive.php">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-user-plus text-dark"></i>
                </div>
                <span class="nav-link-text ms-1">Add Executive</span>
            </a>
        </li>
...
<li class="nav-item">
                    ...
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="../guidance/list.guidance.php">
                                <span class="sidenav-mini-icon"> </span>
                                <span class="sidenav-normal font-weight-bold">Guidances List</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../executive/list.executive.php">
                                <span class="sidenav-mini-icon"> </span>
                                <span class="sidenav-normal font-weight-bold">Executives List</span>
                            </a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="maintenance">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="../guidance/add.guidance.php">
                                <span class="sidenav-mini-icon text-xs"> </span>
                                <span class="sidenav-normal font-weight-bold">Add Guidance</span>
                            </a>
                        </li>
                        ...
                        <a class="nav-link" href="../executive/add.executive.php">
                            <span class="sidenav-mini-icon text-xs"> </span>
                            <span class="sidenav-normal font-weight-bold">Add Executive</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="lists">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <a class="nav-link" href="../executive/list.executive.php">
                            <span class="sidenav-mini-icon"> </span>
                            <span class="sidenav-normal font-weight-bold">Executive List</span>
                        </a>
                    </li>
    ...
    <div class="sidenav-footer mx-3">
        ...
        elseif ($_SESSION['role'] == "Dean") {
            ...
            echo '<a class="btn bg-gradient-light mt-2 mb-3  border-radius-md mx-3" href="../executive/edit.executive.php" data-bs-toggle="tooltip"
                     data-bs-placement="top" title="Personal Info" data-container="body" data-animation="true"><i
                             class="fas fa-user-edit"></i></a>';
